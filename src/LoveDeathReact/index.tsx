...
import songTheme from '../audio/love-death-and-robots-theme-song.mp3'
const Comp = () => {
  const { fps } = useVideoConfig();
  const cuts = [2 * fps, fps, fps + 4, 1, 19, 18, 19, 13, 40, 17, 112] as const;
